!(function () {
  ...
  class s {
    ...
    _load() {
      let t = `${`${`http${this.options.ssl ? "s" : ""}`}://${
        this.options.host
      }`}?support=${this.options.support}&version=${
        this.version
      ...
      return (
        ...
        null !== this.options.limit && (t += `&num=${this.options.limit}`),
        null !== this.options.key && (t += `&key=${this.options.key}`),
        null !== this.options.encoding &&
          (t += `&encoding=${this.options.encoding}`),
        this._fetchFeed(t)
      );
    }
    async _fetchFeed(t) {
